...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.album'
        db.add_column('event_location', 'album',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photo.PhotoAlbum'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.album'
        db.delete_column('event_location', 'album_id')
