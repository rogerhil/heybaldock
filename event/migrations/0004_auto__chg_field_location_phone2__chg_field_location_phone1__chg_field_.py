...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Location.phone2'
        db.alter_column('event_location', 'phone2', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Location.phone1'
        db.alter_column('event_location', 'phone1', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Location.phone3'
        db.alter_column('event_location', 'phone3', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'Location.phone2'
        db.alter_column('event_location', 'phone2', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Location.phone1'
        db.alter_column('event_location', 'phone1', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Location.phone3'
        db.alter_column('event_location', 'phone3', self.gf('django.db.models.fields.IntegerField')(null=True))
