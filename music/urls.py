...
urlpatterns = patterns('',
    ...
    url(r'^repertory/main/item/(?P<id>\d+)/details/$', views.main_repertory_item_details, name='main_repertory_item_details'),
    ...
    url(r'^repertory/main/item/(?P<id>\d+)/tablature/add/$', views.add_tablature_repertory_item, name='add_tablature_repertory_item'),
    url(r'^repertory/main/item/(?P<id>\d+)/tablature/(?P<tablature_id>\d+)/show/$', views.show_tablature_repertory_item, name='show_tablature_repertory_item'),
    url(r'^repertory/main/item/(?P<id>\d+)/tablature/(?P<tablature_id>\d+)/save/$', views.save_tablature_repertory_item, name='save_tablature_repertory_item'),
    ...
    url(r'^repertory/event/add_for_rehearsal/(?P<id>\d+)/ajax/$', views.add_event_repertory_for_rehearsal_ajax, name='add_event_repertory_for_rehearsal_ajax'),
    url(r'^repertory/event/add_for_event/(?P<id>\d+)/ajax/$', views.add_event_repertory_for_event_ajax, name='add_event_repertory_for_event_ajax'),
    ...
    url(r'^repertory/event/(?P<id>\d+)/items/dynamic_ordering/$', views.event_repertory_items_dynamic_ordering, name='event_repertory_items_dynamic_ordering'),
    ...
    url(r'^song/(?P<id>\d+)/lyrics/get/$', views.get_lyrics, name='get_lyrics'),
