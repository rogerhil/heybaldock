...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MusicHistoryChanges'
        db.create_table('music_musichistorychanges', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='music_history', to=orm['auth.User'])),
            ...
            ('content_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('content', self.gf('lib.fields.PickleField')(default='')),
        ))
        db.send_create_signal('music', ['MusicHistoryChanges'])


    def backwards(self, orm):
        # Deleting model 'MusicHistoryChanges'
        db.delete_table('music_musichistorychanges')
