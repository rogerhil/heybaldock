...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventRepertoryItem.empty_duration'
        db.add_column('music_eventrepertoryitem', 'empty_duration',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'EventRepertoryItem.item'
        db.alter_column('music_eventrepertoryitem', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['music.RepertoryItem']))

    def backwards(self, orm):
        # Deleting field 'EventRepertoryItem.empty_duration'
        db.delete_column('music_eventrepertoryitem', 'empty_duration')


        # User chose to not deal with backwards NULL issues for 'EventRepertoryItem.item'
        raise RuntimeError("Cannot reverse this migration. 'EventRepertoryItem.item' and its values cannot be restored.")
