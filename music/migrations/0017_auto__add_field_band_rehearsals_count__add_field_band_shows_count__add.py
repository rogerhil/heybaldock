...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Band.rehearsals_count'
        db.add_column('music_band', 'rehearsals_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Band.shows_count'
        db.add_column('music_band', 'shows_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'RepertoryItem.in_rehearsals_count'
        db.add_column('music_repertoryitem', 'in_rehearsals_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'RepertoryItem.in_shows_count'
        db.add_column('music_repertoryitem', 'in_shows_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Band.rehearsals_count'
        db.delete_column('music_band', 'rehearsals_count')

        # Deleting field 'Band.shows_count'
        db.delete_column('music_band', 'shows_count')

        # Deleting field 'RepertoryItem.in_rehearsals_count'
        db.delete_column('music_repertoryitem', 'in_rehearsals_count')

        # Deleting field 'RepertoryItem.in_shows_count'
        db.delete_column('music_repertoryitem', 'in_shows_count')
    ...
    models = {
        ...
        'event.event': {
            ...
            'band': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'events'", 'null': 'True', 'to': "orm['music.Band']"}),
        ...
        'music.band': {
            ...
            'rehearsals_count': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'shows_count': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        'music.bandartist': {
        ...
        'music.eventrepertory': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'repertories'", 'null': 'True', 'to': "orm['event.Event']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rehearsal': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'repertories'", 'null': 'True', 'to': "orm['music.Rehearsal']"}),
        ...
        'music.eventrepertoryitem': {
            ...
            'times_played': ('django.db.models.fields.IntegerField', [], {'default': '1'})
        },
        'music.imagetype': {
        ...
        'music.rehearsal': {
            ...
            'band': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'rehearsals'", 'to': "orm['music.Band']"}),
        ...
        'music.repertoryitem': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'in_rehearsals_count': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'in_shows_count': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
