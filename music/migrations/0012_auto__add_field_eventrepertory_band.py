...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventRepertory.band'
        db.add_column('music_eventrepertory', 'band',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='event_repertories', null=True, to=orm['music.Band']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventRepertory.band'
        db.delete_column('music_eventrepertory', 'band_id')
