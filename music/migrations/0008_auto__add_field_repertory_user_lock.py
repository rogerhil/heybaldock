...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Repertory.user_lock'
        db.add_column('music_repertory', 'user_lock',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='locked_repertories', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Repertory.user_lock'
        db.delete_column('music_repertory', 'user_lock_id')
    ...
    models = {
        ...
        'music.repertory': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '128'}),
            'user_lock': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'locked_repertories'", 'null': 'True', 'to': "orm['auth.User']"})
        },
