...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('music_rehearsal', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('band', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['music.Band'])),
            ('studio', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['event.Location'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')()),
            ('duration', self.gf('django.db.models.fields.IntegerField')(default=120)),
        ...
        db.send_create_signal('music', ['Rehearsal'])


    def backwards(self, orm):
        # Deleting model 'Rehearsal'
        db.delete_table('music_rehearsal')
