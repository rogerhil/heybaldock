...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RepertoryGroupItem.date'
        db.add_column('music_repertorygroupitem', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Repertory.date'
        db.add_column('music_repertory', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RepertoryGroupItem.date'
        db.delete_column('music_repertorygroupitem', 'date')

        # Deleting field 'Repertory.date'
        db.delete_column('music_repertory', 'date')
