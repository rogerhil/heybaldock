...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'UserRepertoryItemRating', fields ['rate', 'repertory_item', 'user']
        db.delete_unique('music_userrepertoryitemrating', ['rate', 'repertory_item_id', 'user_id'])

        # Removing unique constraint on 'PlayerRepertoryItemRating', fields ['rate', 'player_repertory_item']
        db.delete_unique('music_playerrepertoryitemrating', ['rate', 'player_repertory_item_id'])

        # Adding field 'PlayerRepertoryItemRating.user'
        db.add_column('music_playerrepertoryitemrating', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='player_repertory_items_ratings', to=orm['auth.User']),
                      keep_default=False)
        ...
        # Adding unique constraint on 'UserRepertoryItemRating', fields ['repertory_item', 'user']
        db.create_unique('music_userrepertoryitemrating', ['repertory_item_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserRepertoryItemRating', fields ['repertory_item', 'user']
        db.delete_unique('music_userrepertoryitemrating', ['repertory_item_id', 'user_id'])
        ...
        # Deleting field 'PlayerRepertoryItemRating.user'
        db.delete_column('music_playerrepertoryitemrating', 'user_id')

        # Adding unique constraint on 'PlayerRepertoryItemRating', fields ['rate', 'player_repertory_item']
        db.create_unique('music_playerrepertoryitemrating', ['rate', 'player_repertory_item_id'])

        # Adding unique constraint on 'UserRepertoryItemRating', fields ['rate', 'repertory_item', 'user']
        db.create_unique('music_userrepertoryitemrating', ['rate', 'repertory_item_id', 'user_id'])
