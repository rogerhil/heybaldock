...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventRepertoryItem.times_played'
        db.add_column('music_eventrepertoryitem', 'times_played',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventRepertoryItem.times_played'
        db.delete_column('music_eventrepertoryitem', 'times_played')
