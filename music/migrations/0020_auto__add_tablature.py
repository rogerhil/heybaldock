...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Tablature'
        db.create_table('music_tablature', (
            ...
            ('code', self.gf('lib.fields.PickleField')()),
        ))
        db.send_create_signal('music', ['Tablature'])


    def backwards(self, orm):
        # Deleting model 'Tablature'
        db.delete_table('music_tablature')
    ...
    models = {
        ...
        'music.tablature': {
            'Meta': {'object_name': 'Tablature'},
            'code': ('lib.fields.PickleField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
