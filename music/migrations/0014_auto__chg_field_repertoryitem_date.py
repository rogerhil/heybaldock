...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RepertoryItem.date'
        db.alter_column('music_repertoryitem', 'date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True))

    def backwards(self, orm):

        # Changing field 'RepertoryItem.date'
        db.alter_column('music_repertoryitem', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))
