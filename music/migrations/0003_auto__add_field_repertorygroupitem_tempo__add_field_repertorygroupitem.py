...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RepertoryGroupItem.tempo'
        db.add_column('music_repertorygroupitem', 'tempo',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'RepertoryGroupItem.mode'
        db.add_column('music_repertorygroupitem', 'mode',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RepertoryGroupItem.tempo'
        db.delete_column('music_repertorygroupitem', 'tempo')

        # Deleting field 'RepertoryGroupItem.mode'
        db.delete_column('music_repertorygroupitem', 'mode')
    ...
    models = {
        ...
        'music.song': {
            ...
            'tempo': ('django.db.models.fields.IntegerField', [], {'default': '120'}),
            'tonality': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'})
        },
