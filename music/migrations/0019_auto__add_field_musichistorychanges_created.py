...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MusicHistoryChanges.created'
        db.add_column('music_musichistorychanges', 'created',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MusicHistoryChanges.created'
        db.delete_column('music_musichistorychanges', 'created')
