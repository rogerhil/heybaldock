...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Song.signature'
        db.add_column('music_song', 'signature',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Song.tempo'
        db.alter_column('music_song', 'tempo', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Song.signature'
        db.delete_column('music_song', 'signature')


        # Changing field 'Song.tempo'
        db.alter_column('music_song', 'tempo', self.gf('django.db.models.fields.IntegerField')())
