    ...
    $.circulate = function(el, options) {
        ...
        base.runAnimation = function() {
            ...
            if (base.options.keepGoing) {
                ...
                base.$el.animate({
                    left: ["+=" + (base.options.height / 2) + "px", 'easeInQuad'],
                    top: ["+=" + (base.options.width / 2) + "px", 'easeOutQuad'],
                ...
                .animate({
                    left: ["+=" + (base.options.height / 2) + "px", 'easeOutQuad'],
                    top: ["-=" + (base.options.width / 2) + "px", 'easeInQuad'],
