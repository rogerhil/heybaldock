...
function deletePhotoAlbum() {
	var conf = window.confirm("Are you sure you want to delete this PhotoAlbum? WARNING: ALL RELATED PHOTOS WILL BE LOST!!! the only way to rescue back will be through drafts.");
	if (conf) {
