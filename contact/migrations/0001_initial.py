...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('contact_notification', (
            ...
            ('template', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('template_context', self.gf('lib.fields.PickleField')(null=True, blank=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.IntegerField')(null=True)),
        ))
        db.send_create_signal('contact', ['Notification'])

        # Adding model 'UserNotification'
        db.create_table('contact_usernotification', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('notification', self.gf('django.db.models.fields.related.ForeignKey')(related_name='users_notifications', to=orm['contact.Notification'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='notifications', to=orm['auth.User'])),
            ('read', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('email_sent', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('contact', ['UserNotification'])


    def backwards(self, orm):
        # Deleting model 'Notification'
        db.delete_table('contact_notification')

        # Deleting model 'UserNotification'
        db.delete_table('contact_usernotification')
    ...
    models = {
        ...
        'contact.notification': {
            ...
            'template_context': ('lib.fields.PickleField', [], {'null': 'True', 'blank': 'True'})
        },
        'contact.usernotification': {
            'Meta': {'object_name': 'UserNotification'},
            'email_sent': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'notification': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'users_notifications'", 'to': "orm['contact.Notification']"}),
